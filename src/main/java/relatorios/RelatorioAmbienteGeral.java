...
public class RelatorioAmbienteGeral  extends AbstractTableModel{
        ...
        public static final int INDEX_CIDADE = 5;
        public static final int INDEX_CATEGORIA = 6;
        public static final int INDEX_QUANTIDADE_EMPRESAS = 7;
        public static final int INDEX_ESCONDIDO = 8;

        protected String[] nomeColunas;
        protected Vector<AmbienteGeral> vetorDados;

        public RelatorioAmbienteGeral(String[] columnNames, Vector<AmbienteGeral> vetorDados) {
